...
class LunarDateTimeFormatterTest extends TestCase
{
    ...
    {
        $formater = new LunarDateTimeFormatter(
        ...
        $this->assertEquals('29/02/2023 00:00am', $formater->format('d/L/Y h:ia'));
        $this->assertEquals('29/02+/2023', $formater->format('d/m/Y'));
        $this->assertEquals('29/2/2023 (+)', $formater->format('d/l/Y C'));
    }
}